...
const QString BITCOIN_IPC_PREFIX("bether:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/bether-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/bether-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/bether-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click bether: links
...
//
// OSX-specific way of handling bether: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in bether: URIs
...
bool PaymentServer::handleURI(const QString &scheme, const QString &s)
{
    ...
    else
    {
        Q_EMIT message(tr("URI handling"), tr("URI cannot be parsed! This can be caused by an invalid "
                                              "Bether address or malformed URI parameters."),
            CClientUIInterface::ICON_WARNING);
    }
