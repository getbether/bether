 ...
 * between betherd, and bether-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/getbether/bether>";
    const std::string URL_WEBSITE = "<https://getbether.com/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Bether Developers", 2025)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Bether useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Bether More version %s\n", FormatFullVersion());
}
