...
unlocked to sign the Bether-Qt.app bundle.
...
allowing somebody to distribute a Bether-Qt.app or bether-qt-setup.exe with a valid
...
that the bether-qt.exe file inside the installer had not been tampered with.
